...
# ============================================================
# Architecture: 2 inputs -> Hidden Layer (2 neurons) -> 1 output
# Parameters: 6 weights + 3 biases = 9 total
# ============================================================
...
# ----------------------------------------------------------------
# STEP 3: Activation Function -- Sigmoid (for hidden layer)
# ----------------------------------------------------------------
def sigmoid(z):
...
print("  Architecture: 2 inputs -> Hidden(2 neurons) -> 1 output")
...
for epoch in range(1, epochs + 1):
    ...
    for i in range(n):
        ...
        # Output Neuron (linear activation)
        z_out = w5 * a_h1 + w6 * a_h2 + b3
        y_hat = z_out  # linear: y_hat = z_out
        ...
        dL_dz_h2 = dL_dy_hat * w6 * sigmoid_derivative(z_h2)
